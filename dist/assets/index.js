...
const useStatusStore = /* @__PURE__ */ defineStore("status", {
  ...
  actions: {
    load(callback) {
      fetch(global$1.baseURL + "api/status").then((res) => res.json()).then((json) => {
        this.id = json.id;
        this.rssi = json.rssi;
...
const useConfigStore = /* @__PURE__ */ defineStore("config", {
  ...
  actions: {
    ...
    sendSensorScan(callback) {
      global$1.disabled = true;
      fetch(global$1.baseURL + "api/sensor", {
        headers: { Authorization: global$1.token }
      }).then((res) => {
        if (res.status != 200) {
    ...
    getSensorScanStatus(callback) {
      fetch(global$1.baseURL + "api/sensor/status", {
        method: "GET",
        headers: { Authorization: global$1.token }
      }).then((res) => res.json()).then((json) => {
    ...
    runSensorScan(callback) {
      ...
      this.sendSensorScan((success) => {
        if (success) {
          var check = setInterval(() => {
            this.getSensorScanStatus((success2, data) => {
              if (success2) {
                if (data.status) ;
                else {
                  global$1.disabled = false;
                ...
                global$1.disabled = false;
                global$1.messageError = "Failed to get sensor scan status";
                callback(false);
                clearInterval(check);
              }
            });
          ...
          global$1.disabled = false;
          global$1.messageError = "Failed to start sensor scan";
          callback(false);
        }
      });
    }
...
const _hoisted_2$w = ["value", "name", "id", "disabled"];
          ...
          createBaseVNode("div", _hoisted_1$B, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(options.value, (o) => {
              return openBlock(), createElementBlock(Fragment, {
                ...
                }, toDisplayString(o.label), 9, _hoisted_3$r)
              ], 64);
            }), 128))
          ])
        ]),
...
const _hoisted_2$v = ["data-bs-title", "disabled"];
const _hoisted_3$q = {
  key: 0,
      ...
      return openBlock(), createBlock(_component_BsInputBase, {
        ...
        default: withCtx(() => [
          createBaseVNode("div", _hoisted_1$A, [
            ...
            unit.value !== void 0 ? (openBlock(), createElementBlock("span", _hoisted_3$q, toDisplayString(unit.value), 1)) : createCommentVNode("", true)
          ])
        ]),
        _: 1
      }, 8, ["width", "label", "help", "badge"]);
...
const _hoisted_1$z = { class: "card h-100" };
const _hoisted_2$u = { class: "card-body" };
const _hoisted_3$p = { class: "row" };
const _hoisted_4$n = { class: "col-md-8" };
const _hoisted_5$j = { class: "row text-start" };
const _hoisted_6$j = { class: "row text-start" };
const _hoisted_7$f = { class: "col-md-4 text-center align-self-center justify-content-center" };
const _hoisted_8$f = { class: "row" };
  ...
  setup(__props) {
    ...
    onMounted(() => {
      if (config.enable_cooling || config.enable_heating) {
        ...
        global$1.messageError = "Neither cooling or heating is enabled, control is not possible";
      }
    });
    const saveSettings = () => {
      ...
      fetch(global$1.baseURL + "api/mode", {
        method: "POST",
        headers: { "Content-Type": "application/json", Authorization: global$1.token },
        body: JSON.stringify(data)
      }).then((res) => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$z, [
        _cache[2] || (_cache[2] = createBaseVNode("div", { class: "card-header bg-success-subtle" }, "Controller", -1)),
              ...
              createBaseVNode("div", _hoisted_4$n, [
                createBaseVNode("div", _hoisted_5$j, [
                  createVNode(_sfc_main$O, {
                    modelValue: newMode.value,
                    "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => newMode.value = $event),
                    label: "Change mode",
                ...
                createBaseVNode("div", _hoisted_6$j, [
                  createVNode(_sfc_main$N, {
                    modelValue: newTemperature.value,
                    "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => newTemperature.value = $event),
...
const _hoisted_3$o = { class: "row text-start" };
const _hoisted_4$m = { class: "col-md-10" };
const _hoisted_5$i = { class: "h4" };
const _hoisted_6$i = { class: "row text-start" };
const _hoisted_7$e = { class: "col-md-10" };
const _hoisted_8$e = { class: "h4" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$y, [
        _cache[4] || (_cache[4] = createBaseVNode("div", { class: "card-header bg-success-subtle" }, "Controller", -1)),
        createBaseVNode("div", _hoisted_2$t, [
          createBaseVNode("div", _hoisted_3$o, [
            _cache[0] || (_cache[0] = createBaseVNode("div", { class: "col-md-2" }, "Mode:", -1)),
            createBaseVNode("div", _hoisted_4$m, [
              createBaseVNode("label", _hoisted_5$i, toDisplayString(mode.value), 1)
            ])
          ]),
          createBaseVNode("div", _hoisted_6$i, [
            _cache[1] || (_cache[1] = createBaseVNode("div", { class: "col-md-2" }, "State:", -1)),
            createBaseVNode("div", _hoisted_7$e, [
              createBaseVNode("label", _hoisted_8$e, toDisplayString(state.value), 1)
            ])
          ]),
          createBaseVNode("div", _hoisted_9$c, [
            _cache[2] || (_cache[2] = createBaseVNode("div", { class: "col-md-2" }, "Beer:", -1)),
...
const _hoisted_3$n = { class: "row gy-4" };
const _hoisted_4$l = { class: "col-md-6" };
const _hoisted_5$h = { class: "col-md-6" };
const _hoisted_6$h = { class: "col-md-4" };
const _hoisted_7$d = { class: "text-center" };
const _hoisted_8$d = { class: "col-md-4" };
...
const _sfc_main$K = {
  ...
  setup(__props) {
    ...
    onBeforeMount(() => {
      timer.value = setInterval(updateTimers, 1e3);
    });
    onBeforeUnmount(() => {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$x, [
        ...
        unref(status) ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [], 64)) : createCommentVNode("", true),
        unref(status) ? (openBlock(), createElementBlock("div", _hoisted_2$s, [
          createBaseVNode("div", _hoisted_3$n, [
            ...
            createBaseVNode("div", _hoisted_6$h, [
              createVNode(_component_BsCard, {
                ...
                default: withCtx(() => [
                  createBaseVNode("p", _hoisted_7$d, toDisplayString(unref(status).rssi) + " dBm - " + toDisplayString(unref(status).wifi_ssid), 1)
                ]),
                _: 1
              })
            ]),
            ...
            createBaseVNode("div", _hoisted_10$b, [
              createVNode(_component_BsCard, {
                ...
                default: withCtx(() => [
                  createBaseVNode("p", _hoisted_11$7, " Free: " + toDisplayString(unref(status).free_heap) + " kb, Total: " + toDisplayString(unref(status).total_heap) + " kb ", 1)
                ]),
                _: 1
              })
            ]),
            ...
            createBaseVNode("div", _hoisted_14$3, [
              createVNode(_component_BsCard, {
                ...
                default: withCtx(() => [
                  createBaseVNode("p", _hoisted_15$2, toDisplayString(unref(status).platform), 1)
                ]),
                _: 1
              })
            ]),
...
const _sfc_main$J = {
  ...
  setup(__props) {
    ...
    const factory = () => {
      global$1.clearMessages();
      global$1.disabled = true;
      fetch(global$1.baseURL + "api/factory", { headers: { Authorization: global$1.token } }).then((res) => res.json()).then((json) => {
        ...
        createBaseVNode("form", {
          ...
          createBaseVNode("div", _hoisted_2$r, [
            ...
            createBaseVNode("div", _hoisted_5$g, [
              createVNode(_component_BsInputSwitch, {
                modelValue: unref(config).ble_enabled,
                "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => unref(config).ble_enabled = $event),
                label: "Enable BLE",
            ...
            createBaseVNode("div", _hoisted_7$c, [
              createVNode(_component_BsSelect, {
                ...
                "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => unref(config).restart_interval = $event),
          ...
          createBaseVNode("div", _hoisted_8$c, [
            ...
            createBaseVNode("div", _hoisted_9$a, [
              ...
              createBaseVNode("button", {
                onClick: _cache[5] || (_cache[5] = (...args) => unref(restart) && unref(restart)(...args)),
                type: "button",
...
const _hoisted_1$v = { class: "h4" };
const _hoisted_2$q = { class: "row" };
const _hoisted_3$l = { class: "row" };
const _hoisted_4$j = { class: "col" };
const _hoisted_5$f = ["disabled"];
const _hoisted_6$f = ["hidden"];
const _sfc_main$I = {
  __name: "PidDataFragment",
  props: {
    "source": {},
    "sourceModifiers": {}
  },
  ...
  setup(__props) {
    const data = ref("");
    const source = useModel(__props, "source");
    ...
    const load = () => {
      global$1.clearMessages();
      global$1.disabled = true;
      fetch(global$1.baseURL + "api/pid/" + source.value, { headers: { Authorization: global$1.token } }).then((res) => res.json()).then((json) => {
        data.value = json;
        global$1.disabled = false;
      }).catch((err) => {
        logError("DevicePidsView:load()", err);
        global$1.messageError = "Failed to do load data from /api/" + source.value;
        global$1.disabled = false;
      });
    };
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("p", _hoisted_1$v, toDisplayString(dataSource.value), 1),
        createBaseVNode("div", _hoisted_2$q, [
          createBaseVNode("pre", null, toDisplayString(dataFormatted.value), 1)
        ]),
        createBaseVNode("div", _hoisted_3$l, [
          createBaseVNode("div", _hoisted_4$j, [
            createBaseVNode("button", {
              ...
              _cache[1] || (_cache[1] = createTextVNode("  Reload "))
            ], 8, _hoisted_5$f)
          ])
        ])
      ], 64);
...
const _hoisted_3$k = { class: "col-md-6" };
const _hoisted_4$i = { class: "col-md-6" };
const _hoisted_5$e = { class: "col-md-6" };
const _hoisted_6$e = { class: "col-md-6" };
const _hoisted_7$b = { class: "col-md-4" };
const _hoisted_8$b = { class: "col-md-4" };
        ...
        createBaseVNode("form", {
          ...
          createBaseVNode("div", _hoisted_2$p, [
            ...
            createBaseVNode("div", _hoisted_4$i, [
              createVNode(_component_BsSelect, {
                modelValue: unref(config).beer_sensor_id,
                "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => unref(config).beer_sensor_id = $event),
                label: "Beer Sensor",
...
const _hoisted_10$8 = { class: "col-md-12" };
const _hoisted_11$4 = ["disabled"];
const _hoisted_12$4 = ["hidden"];
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$s, [
        ...
        _cache[14] || (_cache[14] = createBaseVNode("p", { class: "h3" }, "Device - WIFI", -1)),
...
const _hoisted_3$i = { class: "col-md-9" };
const _hoisted_4$g = { class: "col-md-3" };
const _hoisted_5$c = { class: "col-md-9" };
const _hoisted_6$c = { class: "col-md-3" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$r, [
        ...
        _cache[6] || (_cache[6] = createBaseVNode("p", { class: "h3" }, "Push - HTTP Post", -1)),
...
const _hoisted_4$f = { class: "col-md-3" };
const _hoisted_5$b = { class: "col-md-9" };
const _hoisted_6$b = { class: "col-md-3" };
const _hoisted_7$8 = { class: "col-md-9" };
const _hoisted_8$8 = { class: "col-md-3" };
const _hoisted_9$6 = { class: "row gy-2" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$q, [
        _cache[5] || (_cache[5] = createBaseVNode("p", null, null, -1)),
        _cache[6] || (_cache[6] = createBaseVNode("p", { class: "h3" }, "Push - HTTP Get", -1)),
        _cache[7] || (_cache[7] = createBaseVNode("hr", null, null, -1)),
        createBaseVNode("form", {
          onSubmit: withModifiers(save, ["prevent"]),
          class: "needs-validation",
...
const _hoisted_3$g = { class: "col-md-12" };
const _hoisted_4$e = { class: "col-md-6" };
const _hoisted_5$a = { class: "col-md-6" };
const _hoisted_6$a = { class: "col-md-6" };
const _hoisted_7$7 = { class: "row gy-2" };
const _hoisted_8$7 = { class: "col-sm-3" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$p, [
        ...
        _cache[7] || (_cache[7] = createBaseVNode("p", { class: "h3" }, "Push - Influxdb v2", -1)),
...
const _hoisted_3$f = { class: "col-md-9" };
const _hoisted_4$d = { class: "col-md-3" };
const _hoisted_5$9 = { class: "col-md-6" };
const _hoisted_6$9 = { class: "col-md-6" };
const _hoisted_7$6 = { class: "row gy-2" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$o, [
        _cache[6] || (_cache[6] = createBaseVNode("p", null, null, -1)),
        _cache[7] || (_cache[7] = createBaseVNode("p", { class: "h3" }, "Push - MQTT", -1)),
        _cache[8] || (_cache[8] = createBaseVNode("hr", null, null, -1)),
        createBaseVNode("form", {
          onSubmit: withModifiers(save, ["prevent"]),
          class: "needs-validation",
          ...
          createBaseVNode("div", _hoisted_2$k, [
            createBaseVNode("div", _hoisted_3$f, [
              createVNode(_component_BsInputText, {
                modelValue: unref(config).mqtt_push,
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => unref(config).mqtt_push = $event),
                maxlength: "120",
                label: "Server",
...
const _hoisted_3$e = { class: "col-md-12" };
const _hoisted_4$c = { class: "row gy-2" };
const _hoisted_5$8 = { class: "col-md-3" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$n, [
        ...
        unref(status).platform !== "esp32s2" ? (openBlock(), createElementBlock("form", {
          ...
          createBaseVNode("div", _hoisted_2$j, [
            createBaseVNode("div", _hoisted_3$e, [
              createVNode(_component_BsInputSwitch, {
                modelValue: unref(config).ble_enabled,
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => unref(config).ble_enabled = $event),
        ...
        ], 32)) : (openBlock(), createElementBlock("div", _hoisted_8$5, _cache[4] || (_cache[4] = [
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$m, [
        ...
        createBaseVNode("div", _hoisted_2$i, [
          createBaseVNode("form", {
            ...
            progress.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_10$3, [
...
const _hoisted_2$h = { class: "row" };
const _hoisted_3$c = { class: "col" };
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$l, [
        _cache[3] || (_cache[3] = createStaticVNode('<p></p><p class="h3">Support</p><hr><div class="row"><p> If you need support, want to discuss the software or request any new features you can do that on github.com. </p></div><div class="row"><div class="col-md-4"><a class="link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="https://github.com/mp-se/chamber-controller" target="_blank">Chamber controller</a></div></div><hr>', 6)),
...
const _hoisted_2$g = { class: "h3" };
const _hoisted_3$b = { class: "row gy-2" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$k, [
        ...
        createBaseVNode("p", _hoisted_2$g, "Serial console (" + toDisplayString(connected.value) + ")", 1),
        _cache[3] || (_cache[3] = createBaseVNode("hr", null, null, -1)),
...
const _hoisted_2$f = { class: "col-md-3" };
...
const _hoisted_2$e = { class: "col-md-12" };
const _hoisted_3$9 = { class: "col-md-3" };
...
const _hoisted_1$h = { class: "row gy-4" };
const _hoisted_2$d = { class: "col-md-3" };
...
const _hoisted_3$7 = { class: "col-md-2" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$g, [
        ...
        hideAdvanced.value ? (openBlock(), createElementBlock("div", _hoisted_2$c, [
...
function _sfc_render(_ctx, _cache) {
  ...
  return openBlock(), createBlock(_component_BsMessage, {
    ...
    default: withCtx(() => [
      ...
      createBaseVNode("span", _hoisted_1$f, toDisplayString(this.$route.path), 1),
...
const _hoisted_1$e = { class: "navbar navbar-expand-lg navbar-dark bg-primary" };
const _hoisted_2$b = { class: "container-fluid align-center" };
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("nav", _hoisted_1$e, [
        createBaseVNode("div", _hoisted_2$b, [
          ...
          createBaseVNode("div", _hoisted_3$6, toDisplayString(brand.value), 1),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$d, [
        ...
        createBaseVNode("div", _hoisted_2$a, toDisplayString(text.value), 1)
      ]);
    };
  }
};
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        !unref(global$1).initialized ? (openBlock(), createElementBlock("div", _hoisted_1$c, [
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        alert.value === "danger" ? (openBlock(), createBlock(_sfc_main$o, {
          key: 0,
          height: "20",
          width: "20"
        })) : createCommentVNode("", true),
        alert.value === "warning" ? (openBlock(), createBlock(_sfc_main$l, {
          key: 1,
          height: "20",
          width: "20"
        })) : createCommentVNode("", true),
        alert.value === "info" ? (openBlock(), createBlock(_sfc_main$m, {
          key: 2,
          height: "20",
          width: "20"
        })) : createCommentVNode("", true),
        alert.value === "success" ? (openBlock(), createBlock(_sfc_main$n, {
          key: 3,
          height: "20",
          width: "20"
        })) : createCommentVNode("", true),
        ...
        dismissable.value && close.value === void 0 ? (openBlock(), createElementBlock("button", _hoisted_1$b)) : createCommentVNode("", true)
      ], 2);
    };
  }
});
        ...
        default: withCtx(() => [
          createBaseVNode("div", _hoisted_1$9, [
            createBaseVNode("input", mergeProps({
              class: "form-control",
              type: "file"
            }, _ctx.$attrs, { disabled: disabled.value }), null, 16, _hoisted_2$7)
          ])
        ]),
        _: 1
      }, 8, ["width", "label", "help", "badge"]);
...
const _hoisted_1$7 = { class: "has-validation pt-2" };
const _hoisted_2$6 = {
  key: 0,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$7, [
        label.value !== void 0 ? (openBlock(), createElementBlock("label", _hoisted_2$6, toDisplayString(label.value), 1)) : createCommentVNode("", true),
        _cache[0] || (_cache[0] = createTextVNode("  ")),
        badge.value ? (openBlock(), createElementBlock("span", _hoisted_3$4, "1")) : createCommentVNode("", true),
        createBaseVNode("div", {
...
const _hoisted_2$5 = ["type", "data-bs-title"];
const _hoisted_3$3 = {
  key: 0,
  class: "input-group-text"
};
      ...
      return openBlock(), createBlock(_component_BsInputBase, {
        ...
        default: withCtx(() => [
          createBaseVNode("div", _hoisted_1$6, [
            ...
            type.value === "password" ? (openBlock(), createElementBlock("span", _hoisted_3$3, [
              ...
              flag.value ? (openBlock(), createBlock(_sfc_main$f, {
                key: 1,
                onClick: toggle,
                width: "1rem",
                height: "1rem"
          ...
          withDirectives(createBaseVNode("select", mergeProps({
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(options.value, (o) => {
              return openBlock(), createElementBlock(Fragment, {
                ...
                ], 8, _hoisted_2$3)) : (openBlock(), createElementBlock("option", {
                  key: 1,
                  value: o.value
            ...
            createBaseVNode("ul", _hoisted_3$1, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(options.value, (o) => {
                return openBlock(), createElementBlock("li", {
                  ...
                  }, toDisplayString(o.label), 9, _hoisted_4$1)
                ]);
              }), 128))
            ])
          ])
...
app.use(router);
app.component("BsMessage", _sfc_main$k);
app.component("BsDropdown", _sfc_main$7);
app.component("BsCard", _sfc_main$j);
app.component("BsFileUpload", _sfc_main$i);
app.component("BsProgress", _sfc_main$h);
app.component("BsInputBase", _sfc_main$g);
app.component("BsInputText", _sfc_main$d);
app.component("BsInputReadonly", _sfc_main$c);
app.component("BsSelect", _sfc_main$a);
app.component("BsInputTextArea", _sfc_main$9);
app.component("BsInputNumber", _sfc_main$N);
app.component("BsInputRadio", _sfc_main$O);
app.component("BsInputSwitch", _sfc_main$8);
app.component("BsModalConfirm", _sfc_main$6);
app.component("IconHome", _sfc_main$5);
app.component("IconTools", _sfc_main$4);
app.component("IconGraphUpArrow", _sfc_main$3);
